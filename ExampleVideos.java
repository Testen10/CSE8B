...
class Video{
    ...
    Video(String title, User reference, int cnt_like, String id){
        this.title = title;
...
class User{
    ...
    */
    ...
    User(String username,String displayName, int num_subscriber, int num_video){
...
// Two video from user1
    // Q: “Were there any parts of the Video class that you couldn’t represent with the class design we chose?”
        // A: The class doesn't represent the thumbnail image of the video
    Video video1 = new Video("米津玄師 - Lemon Kenshi Yonezu", user1, 3100000, "SX_ViT4Ra7k"); // link: https://www.youtube.com/watch?v=SX_ViT4Ra7k
    
    // Q: “Were there any parts of the Video class that you couldn’t represent with the class design we chose?”
        // A: The class doesn't represent thhe number of dislikes of the video
    Video video2 = new Video("米津玄師 - 感電 Kenshi Yonezu - KANDEN", user1, 3100000, "UFQEttrn6CQ"); // link: https://www.youtube.com/watch?v=UFQEttrn6CQ

// video from user2
    // Q: “Were there any parts of the Video class that you couldn’t represent with the class design we chose?”
        // A: The class doesn't represent the text in description of the video
    Video video3 = new Video("Gumi Eng. & Yohioloid / The Chattering Lack of Common Sense [Original Song]", user2, 190000, "ksW7SuH6IAs"); // link: https://www.youtube.com/watch?v=ksW7SuH6IAs
    
// video from user3
    // Q: “Were there any parts of the Video class that you couldn’t represent with the class design we chose?”
        // A: The class doesn't represent the number of comments of the video
    Video video4 = new Video("Guckkasten 국카스텐 [사냥] Music Video", user3, 8200, "kuvQxTq3ccI"); // link: https://www.youtube.com/watch?v=kuvQxTq3ccI
